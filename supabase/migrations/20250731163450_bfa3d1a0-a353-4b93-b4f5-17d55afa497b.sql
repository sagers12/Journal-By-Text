-- Simplify category rotation to 10-day sequential system
-- Drop the complex category tracking table and replace with simple day-based rotation

-- Drop the user_last_prompt_category table as it's no longer needed
DROP TABLE IF EXISTS public.user_last_prompt_category;

-- Create simplified function for 10-day sequential category rotation
...
BEGIN
  ...
  -- Calculate how many days since baseline
  days_since_baseline := EXTRACT(DAY FROM CURRENT_DATE - user_baseline_date);
