...
export const JournalDashboard = () => {
  ...
  const handleEditEntry = (id: string, newContent: string, tags?: string[], photos?: File[], removedPhotos?: string[]) => {
    updateEntry(id, newContent.trim(), tags, photos, removedPhotos);
  };
